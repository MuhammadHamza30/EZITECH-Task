              ...
              <ul
                className={`${
                  show
                    ...
                    : "flex items-center gap-6 text-white uppercase font-bold"
                }`}
              >
                <li className="hover:text-sky-700 hover:underline"><a href="/" >Home</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">AboutUs</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">Certification</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">Careers</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">Seminars</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">Tech Blogs</a></li>
                <li className="hover:text-sky-700 hover:underline"><a href="">IPORTAL LOGIN</a></li>
              </ul>
